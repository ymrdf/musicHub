  ...
  const playOptions = [
    {
      id: "download",
      title: "Download File",
      description: "Download to local device, play with professional software",
    ...
    },
    {
      id: "online",
      title: "Online Player",
      description: "Play using online MIDI player",
      icon: GlobeAltIcon,
    ...
    },
    {
      id: "system",
      title: "System Player",
      description: "Use system default player",
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-blue-700 mt-1">
                  MIDI files contain musical data rather than audio waveforms
                  and require sound libraries to play. Browsers cannot directly
                  play MIDI files, please choose one of the following options:
                </p>
              </div>
            </div>
          </div>
